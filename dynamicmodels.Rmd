...
compute_metrics = function(sens_result) {
  ...
  idx = which.max(sens_result$forest_size)
  max_year = sens_result$time[idx]
return(list(max_size=max_size, max_year = max_year))}
...
wrapper = function(r, g, C, closure, K, temp, sim_times, func) {
    parms = list(r=r, g=g, C = 10, temp = 20, closure = 100, K = 500)
...
colnames(allres) = c("max_size", "max_year")
